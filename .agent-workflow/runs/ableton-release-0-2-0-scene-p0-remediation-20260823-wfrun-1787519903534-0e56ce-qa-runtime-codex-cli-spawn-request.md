...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-release-0-2-0-scene-p0-remediation-20260823:wfrun-1787519903534-0e56ce:qa:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-release-0-2-0-scene-p0-remediation-20260823:wfrun-1787519903534-0e56ce:qa:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-qa-qa-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-release-0-2-0-scene-p0-remediation-20260823:wfrun-1787519903534-0e56ce:qa:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
- Prompt artifact: .agent-workflow/runs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-qa-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-qa-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-qa-qa-runtime-handoff.md
...
## Quality Warnings
- context token estimate 5719 exceeds budget 3000
