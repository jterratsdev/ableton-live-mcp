# Runtime Child Prompt: ableton-product-high-level-workflows-20260720

- Runtime: codex-cli
- Task id: ableton-product-high-level-workflows-20260720
- Phase: developer
- Role: developer
- Session id: ableton-product-high-level-workflows-20260720:wfrun-1784584721366-fb41bb:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Provide product-level operations above raw endpoint calls for music production.

## Acceptance Criteria
- Define high-level workflows for classical session setup, instrument assignment, mix balancing, reverb cleanup, mastering prep, and render validation.
- Represent each workflow as a deterministic plan over existing MCP tools without directly mutating Ableton.
- Add tests that generated plans use only known tool names and declare risk tiers.
...
- sourcePath: docs/high-level-workflows.md
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: docs/high-level-workflows.md.
...
- sourcePath: src/workflow-plans.js
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: src/workflow-plans.js.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- sourcePath: test/workflow-plans.mjs
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: test/workflow-plans.mjs.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- Load budget: small
- Rationale: eligible task roles: developer; task text matches triggers: generated, docs; task touches files, so prompt registry can preserve artifact intent
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-product-high-level-workflows-20260720-wfrun-1784584721366-fb41bb-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-product-high-level-workflows-20260720-wfrun-1784584721366-fb41bb-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-product-high-level-workflows-20260720:wfrun-1784584721366-fb41bb:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-product-high-level-workflows-20260720-wfrun-1784584721366-fb41bb-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-product-high-level-workflows-20260720:wfrun-1784584721366-fb41bb:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
