...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-capability-aware-tool-exposure-20260819-wfrun-1787123719806-3f4a90-architect-architect-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-capability-aware-tool-exposure-20260819-wfrun-1787123719806-3f4a90-architect-architect-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-capability-aware-tool-exposure-20260819:wfrun-1787123719806-3f4a90:architect:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-capability-aware-tool-exposure-20260819-wfrun-1787123719806-3f4a90-architect-architect-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-capability-aware-tool-exposure-20260819:wfrun-1787123719806-3f4a90:architect:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
