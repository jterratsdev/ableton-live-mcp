# Runtime Child Prompt: ableton-ssd-multi-output-workflow-20260817
...
## Goal
Provide a verified MCP workflow that discovers SSD5 output routing and can create named Live audio receiver tracks for selected plugin outputs.
...
- Targeted Node and Python fake-Live tests plus npm test exit successfully without invoking a mutating endpoint on the user's active Ableton Set.
...
- Load budget: small
- Rationale: eligible task roles: developer, qa; task text matches triggers: map, fixture, fixtures
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: developer, qa; task text matches triggers: failure, error
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: developer, qa; task text matches triggers: source, docs
- Instructions:
...
- Load budget: normal
- Rationale: eligible task roles: qa, developer; task text matches triggers: audio
- Instructions:
...
- Load budget: normal
- Rationale: eligible task roles: developer, qa; task text matches triggers: plugin
- Instructions:
...
- Load budget: normal
- Rationale: task text matches triggers: deploy, rollback
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-ssd-multi-output-workflow-20260817-wfrun-1787002057777-44ad19-qa-qa-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-ssd-multi-output-workflow-20260817-wfrun-1787002057777-44ad19-qa-qa-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-ssd-multi-output-workflow-20260817:wfrun-1787002057777-44ad19:qa:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-ssd-multi-output-workflow-20260817-wfrun-1787002057777-44ad19-qa-qa-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-ssd-multi-output-workflow-20260817:wfrun-1787002057777-44ad19:qa:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
