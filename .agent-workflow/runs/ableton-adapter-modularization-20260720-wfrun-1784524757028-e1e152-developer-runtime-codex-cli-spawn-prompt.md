# Runtime Child Prompt: ableton-adapter-modularization-20260720

- Runtime: codex-cli
- Task id: ableton-adapter-modularization-20260720
- Phase: developer
- Role: developer
- Session id: ableton-adapter-modularization-20260720:wfrun-1784524757028-e1e152:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Split oversized development and Remote Script adapter modules into smaller domain modules while preserving the public bridge and MCP contracts.

## Acceptance Criteria
- Development adapter behavior is split by domain or helpers so endpoint additions do not keep growing one monolith.
- Ableton Remote Script Live API code is organized into smaller importable domain modules or package helpers without changing HTTP route behavior.
- Public MCP tools, bridge action names, and documented endpoint contracts remain backward compatible.
- npm test and Python Remote Script compilation pass after the refactor.
...
- Load budget: small
- Rationale: eligible task roles: developer; task text matches triggers: code, docs; task touches files, so prompt registry can preserve artifact intent
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-adapter-modularization-20260720-wfrun-1784524757028-e1e152-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-adapter-modularization-20260720-wfrun-1784524757028-e1e152-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-adapter-modularization-20260720:wfrun-1784524757028-e1e152:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-adapter-modularization-20260720-wfrun-1784524757028-e1e152-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-adapter-modularization-20260720:wfrun-1784524757028-e1e152:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
