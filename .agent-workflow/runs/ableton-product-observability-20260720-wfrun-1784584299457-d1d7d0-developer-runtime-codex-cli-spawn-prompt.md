# Runtime Child Prompt: ableton-product-observability-20260720

- Runtime: codex-cli
- Task id: ableton-product-observability-20260720
- Phase: developer
- Role: developer
- Session id: ableton-product-observability-20260720:wfrun-1784584299457-d1d7d0:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Expose enough runtime metadata to debug product issues quickly.

## Acceptance Criteria
- Define bridge/version metadata including build hash or installed file timestamps, Live PID, endpoint support, and last error.
- Add deterministic observability support without requiring Ableton.
- Document how observability helps diagnose stale Remote Script runtime issues.
...
- sourcePath: bridge/observability.js
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: bridge/observability.js.
...
- sourcePath: ableton_remote_scripts/AbletonMcpBridge/live_observability.py
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: ableton_remote_scripts/AbletonMcpBridge/live_observability.py.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: docs/observability.md.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- sourcePath: test/observability.mjs
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: test/observability.mjs.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- Load budget: small
- Rationale: eligible task roles: developer; task text matches triggers: error
- Instructions:
...
- Load budget: small
- Rationale: task text matches triggers: issue
- Instructions:
...
- Load budget: normal
- Rationale: task text matches triggers: observability
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-product-observability-20260720-wfrun-1784584299457-d1d7d0-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-product-observability-20260720-wfrun-1784584299457-d1d7d0-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-product-observability-20260720:wfrun-1784584299457-d1d7d0:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-product-observability-20260720-wfrun-1784584299457-d1d7d0-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-product-observability-20260720:wfrun-1784584299457-d1d7d0:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
