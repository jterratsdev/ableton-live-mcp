...
- Phase: developer
- Role: developer
- Session id: ableton-live-meter-cache-20260722:wfrun-1784740647384-649ec9:developer:codex-cli
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-live-meter-cache-20260722-wfrun-1784740647384-649ec9-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-live-meter-cache-20260722-wfrun-1784740647384-649ec9-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-live-meter-cache-20260722:wfrun-1784740647384-649ec9:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-live-meter-cache-20260722-wfrun-1784740647384-649ec9-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-live-meter-cache-20260722:wfrun-1784740647384-649ec9:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
