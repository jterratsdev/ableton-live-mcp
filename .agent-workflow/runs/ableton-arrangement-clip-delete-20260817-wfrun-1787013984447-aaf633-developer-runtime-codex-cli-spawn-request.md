# Runtime Spawn Request: ableton-arrangement-clip-delete-20260817
...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-arrangement-clip-delete-20260817:wfrun-1787013984447-aaf633:developer:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-arrangement-clip-delete-20260817:wfrun-1787013984447-aaf633:developer:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-arrangement-clip-delete-20260817-wfrun-1787013984447-aaf633-developer-developer-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-arrangement-clip-delete-20260817:wfrun-1787013984447-aaf633:developer:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
- Prompt artifact: .agent-workflow/runs/ableton-arrangement-clip-delete-20260817-wfrun-1787013984447-aaf633-developer-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-arrangement-clip-delete-20260817-wfrun-1787013984447-aaf633-developer-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-arrangement-clip-delete-20260817-wfrun-1787013984447-aaf633-developer-developer-runtime-handoff.md
...
## Selected Skills
- collection-standards: eligible task roles: developer, qa; task text matches triggers: fixture, fixtures, selector, selectors
- prompt-registry: eligible task roles: developer, qa; task text matches triggers: code, ui, docs; task touches files, so prompt registry can preserve artifact intent
- pr-review: eligible task roles: qa; task text matches triggers: pr, review, diff
...
## Quality Warnings
- context token estimate 6188 exceeds budget 3000
