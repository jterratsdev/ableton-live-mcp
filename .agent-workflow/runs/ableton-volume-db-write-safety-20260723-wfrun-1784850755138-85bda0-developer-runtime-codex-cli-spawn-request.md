# Runtime Spawn Request: ableton-volume-db-write-safety-20260723
...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-volume-db-write-safety-20260723:wfrun-1784850755138-85bda0:developer:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-volume-db-write-safety-20260723:wfrun-1784850755138-85bda0:developer:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-volume-db-write-safety-20260723-wfrun-1784850755138-85bda0-developer-developer-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-volume-db-write-safety-20260723:wfrun-1784850755138-85bda0:developer:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
## Assignment
- Ownership paths: ableton_remote_scripts/AbletonMcpBridge/live_core.py, ableton_remote_scripts/AbletonMcpBridge/live_mixer.py, bridge/development/mixer.js, docs, test
...
- Prompt artifact: .agent-workflow/runs/ableton-volume-db-write-safety-20260723-wfrun-1784850755138-85bda0-developer-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-volume-db-write-safety-20260723-wfrun-1784850755138-85bda0-developer-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-volume-db-write-safety-20260723-wfrun-1784850755138-85bda0-developer-developer-runtime-handoff.md
...
## Selected Skills
- collection-standards: eligible task roles: developer; task text matches triggers: map, option
...
## Quality Warnings
- context token estimate 4409 exceeds budget 3000
