# Runtime Spawn Request: ableton-product-docs-workflows-20260720
...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-product-docs-workflows-20260720:wfrun-1784584574378-7942d4:developer:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-product-docs-workflows-20260720:wfrun-1784584574378-7942d4:developer:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-product-docs-workflows-20260720-wfrun-1784584574378-7942d4-developer-developer-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-product-docs-workflows-20260720:wfrun-1784584574378-7942d4:developer:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
## Assignment
- Ownership paths: docs/product-workflows.md, README.md
...
- Prompt artifact: .agent-workflow/runs/ableton-product-docs-workflows-20260720-wfrun-1784584574378-7942d4-developer-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-product-docs-workflows-20260720-wfrun-1784584574378-7942d4-developer-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-product-docs-workflows-20260720-wfrun-1784584574378-7942d4-developer-developer-runtime-handoff.md
...
## Selected Skills
- prompt-registry: eligible task roles: developer; task text matches triggers: ui, docs; task touches files, so prompt registry can preserve artifact intent
- source-of-truth: eligible task roles: developer; task text matches triggers: documentation, docs
- doc-sync: task text matches triggers: documentation, docs, readme
...
## Quality Warnings
- context token estimate 4189 exceeds budget 3000
