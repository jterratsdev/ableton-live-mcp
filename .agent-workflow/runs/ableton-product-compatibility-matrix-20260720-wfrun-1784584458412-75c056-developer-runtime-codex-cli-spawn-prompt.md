# Runtime Child Prompt: ableton-product-compatibility-matrix-20260720

- Runtime: codex-cli
- Task id: ableton-product-compatibility-matrix-20260720
- Phase: developer
- Role: developer
- Session id: ableton-product-compatibility-matrix-20260720:wfrun-1784584458412-75c056:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Give users clear expectations about which product capabilities work in their Ableton edition.

## Acceptance Criteria
- Document endpoint support expectations for Live Lite, Standard, Suite, Live 11, and Live 12 where known.
- Mark unsupported Remote Script behaviors as explicit 501 expectations, not bugs.
- Add a deterministic check that compatibility metadata stays parseable and complete.
...
- sourcePath: docs/ableton-compatibility.md
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: docs/ableton-compatibility.md.
...
- sourcePath: test/compatibility-matrix.mjs
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: test/compatibility-matrix.mjs.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- Load budget: small
- Rationale: eligible task roles: developer; task text matches triggers: matrix
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-product-compatibility-matrix-20260720-wfrun-1784584458412-75c056-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-product-compatibility-matrix-20260720-wfrun-1784584458412-75c056-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-product-compatibility-matrix-20260720:wfrun-1784584458412-75c056:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-product-compatibility-matrix-20260720-wfrun-1784584458412-75c056-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-product-compatibility-matrix-20260720:wfrun-1784584458412-75c056:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
