# Runtime Spawn Request: ableton-release-0-2-0-scene-p0-remediation-20260823
...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-release-0-2-0-scene-p0-remediation-20260823:wfrun-1787519903534-0e56ce:developer:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-release-0-2-0-scene-p0-remediation-20260823:wfrun-1787519903534-0e56ce:developer:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-developer-developer-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-release-0-2-0-scene-p0-remediation-20260823:wfrun-1787519903534-0e56ce:developer:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
## Assignment
- Ownership paths: bridge/development/scene-tempo-signature.js, ableton_remote_scripts/AbletonMcpBridge/live_scene_tempo_signature.py, test/scene-tempo-signature.mjs, test/live_scene_tempo_signature_test.py
...
- Prompt artifact: .agent-workflow/runs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-developer-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-developer-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-developer-developer-runtime-handoff.md
...
## Selected Skills
- pr-review: eligible task roles: qa; task text matches triggers: pr, diff
- static-analysis: eligible task roles: developer, qa; task text matches triggers: test
- prompt-registry: eligible task roles: developer, qa; task touches files, so prompt registry can preserve artifact intent
- release-readiness: task text matches triggers: release, rollback
- source-of-truth: eligible task roles: developer, qa; baseline source selection should run for every task
...
## Quality Warnings
- context token estimate 4711 exceeds budget 3000
