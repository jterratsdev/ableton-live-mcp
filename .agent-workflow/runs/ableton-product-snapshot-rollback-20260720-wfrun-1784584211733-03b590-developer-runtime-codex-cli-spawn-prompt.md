# Runtime Child Prompt: ableton-product-snapshot-rollback-20260720

- Runtime: codex-cli
- Task id: ableton-product-snapshot-rollback-20260720
- Phase: developer
- Role: developer
- Session id: ableton-product-snapshot-rollback-20260720:wfrun-1784584211733-03b590:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Make rollback semantics reliable enough for guarded production edits.

## Acceptance Criteria
- Document the current rollback coverage and gaps for tempo, signature, clips, devices, routing, sends, and master chain.
- Improve deterministic snapshot coverage for devices, mixer state, sends, returns, and master chain.
- Keep Remote Script limitations explicit instead of claiming unsupported rollback safety.
...
- original: 304 lines / 15571 bytes
- final: 269 lines / 14251 bytes
...
- omittedContentWarning: Source path was unavailable during preprocessing: bridge/development/snapshots.js.
...
- originalSize: 84 lines / 3261 bytes
- finalSize: 49 lines / 1942 bytes
- omittedContentWarning: Reduced from 84 lines using head-tail-truncation; full source remains at ableton_remote_scripts/AbletonMcpBridge/live_snapshots.py.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
from .live_summaries import clip_note_summary, track_type
...
def track_snapshot(index, track):
    return {
        ...
        "clips": [clip_snapshot(slot_index, slot) for slot_index, slot in enumerate(getattr(track, "clip_slots", [])) if getattr(slot, "has_clip", False)]
    }


[... omitted 36 lines; full source path available ...]
...
- sourcePath: docs/snapshot-rollback.md
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: docs/snapshot-rollback.md.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- sourcePath: test/snapshot-rollback.mjs
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: test/snapshot-rollback.mjs.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-product-snapshot-rollback-20260720-wfrun-1784584211733-03b590-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-product-snapshot-rollback-20260720-wfrun-1784584211733-03b590-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-product-snapshot-rollback-20260720:wfrun-1784584211733-03b590:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-product-snapshot-rollback-20260720-wfrun-1784584211733-03b590-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-product-snapshot-rollback-20260720:wfrun-1784584211733-03b590:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
