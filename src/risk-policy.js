...
const HTTP_ENDPOINT_RISKS = Object.freeze({
  ...
  "GET /routing/plugin-outputs/plan": read("Read exact plugin output routing options without changing Live state."),
  "POST /routing/plugin-outputs/apply": safeWrite("Create verified audio receiver tracks for explicit plugin output routes."),
...
const MCP_TOOL_RISKS = Object.freeze({
  ...
  ableton_plan_plugin_output_routing: tool("GET /routing/plugin-outputs/plan"),
  ableton_apply_plugin_output_routing: tool("POST /routing/plugin-outputs/apply"),
