# Runtime Child Prompt: ableton-volume-db-write-safety-20260723

- Runtime: codex-cli
- Task id: ableton-volume-db-write-safety-20260723
- Phase: developer
- Role: developer
- Session id: ableton-volume-db-write-safety-20260723:wfrun-1784850755138-85bda0:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Guarantee that volumeDb writes target the requested Ableton display dB without corrupting track levels through an incorrect raw-value conversion.

## Acceptance Criteria
- Volume writes use Live parameter conversion/display semantics or a verified calibrated mapping rather than assuming a linear raw scale.
- Responses report requested dB, raw value written, observed raw value, observed display/dB, tolerance, and confirmation.
- Unsafe or unverifiable dB writes fail closed and do not report success.
- Automated round-trip tests cover the restored levels -7.372, -8.337, -10.161, and -5.68 dB plus boundary values.
- No live mixer writes occur until the user explicitly approves post-reinstall validation.
...
- original: 1048 lines / 42860 bytes
- final: 360 lines / 16502 bytes
...
- sourcePath: ableton_remote_scripts/AbletonMcpBridge/live_core.py
- strategy: head-tail-truncation
- originalSize: 93 lines / 2288 bytes
- finalSize: 49 lines / 1108 bytes
- omittedContentWarning: Reduced from 93 lines using head-tail-truncation; full source remains at ableton_remote_scripts/AbletonMcpBridge/live_core.py.
...
[... omitted 45 lines; full source path available ...]
        return None
    try:
...
- sourcePath: ableton_remote_scripts/AbletonMcpBridge/live_mixer.py
- strategy: head-tail-truncation
- originalSize: 536 lines / 20985 bytes
- finalSize: 49 lines / 1723 bytes
- omittedContentWarning: Reduced from 536 lines using head-tail-truncation; full source remains at ableton_remote_scripts/AbletonMcpBridge/live_mixer.py.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
[... omitted 488 lines; full source path available ...]
...
- sourcePath: bridge/development/mixer.js
- strategy: head-tail-truncation
- originalSize: 199 lines / 7277 bytes
- finalSize: 42 lines / 1362 bytes
- omittedContentWarning: Reduced from 199 lines using head-tail-truncation; full source remains at bridge/development/mixer.js.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
[... omitted 158 lines; full source path available ...]
...
- Load budget: small
- Rationale: eligible task roles: developer; task text matches triggers: map, option
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-volume-db-write-safety-20260723-wfrun-1784850755138-85bda0-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-volume-db-write-safety-20260723-wfrun-1784850755138-85bda0-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-volume-db-write-safety-20260723:wfrun-1784850755138-85bda0:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-volume-db-write-safety-20260723-wfrun-1784850755138-85bda0-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-volume-db-write-safety-20260723:wfrun-1784850755138-85bda0:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
