...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-live-meter-cache-20260722:wfrun-1784740603830-e249aa:developer:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-live-meter-cache-20260722:wfrun-1784740603830-e249aa:developer:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-live-meter-cache-20260722-wfrun-1784740603830-e249aa-developer-developer-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-live-meter-cache-20260722:wfrun-1784740603830-e249aa:developer:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
- Prompt artifact: .agent-workflow/runs/ableton-live-meter-cache-20260722-wfrun-1784740603830-e249aa-developer-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-live-meter-cache-20260722-wfrun-1784740603830-e249aa-developer-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-live-meter-cache-20260722-wfrun-1784740603830-e249aa-developer-developer-runtime-handoff.md
