# Runtime Child Prompt: ableton-fix-gh-issues-1-5-20260817
...
- Round-trip contract tests assert parameter writes, realistic-scale clip creation, mastering chain order and completeness, and inventory-backed preset recommendations; targeted tests and npm test exit successfully.
...
- Load budget: normal
- Rationale: eligible task roles: qa; task text matches triggers: browser, ui
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: developer, qa; task text matches triggers: docs, verify
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: developer, qa; task text matches triggers: error
- Instructions:
...
- Load budget: normal
- Rationale: eligible task roles: qa; task text matches triggers: pr
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: developer, qa; task text matches triggers: orchestra
- Instructions:
...
- Load budget: small
- Rationale: task text matches triggers: issue, github
- Instructions:
...
- Load budget: normal
- Rationale: task text matches triggers: release
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-fix-gh-issues-1-5-20260817-wfrun-1786992298465-e7fa9f-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-fix-gh-issues-1-5-20260817-wfrun-1786992298465-e7fa9f-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-fix-gh-issues-1-5-20260817:wfrun-1786992298465-e7fa9f:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-fix-gh-issues-1-5-20260817-wfrun-1786992298465-e7fa9f-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-fix-gh-issues-1-5-20260817:wfrun-1786992298465-e7fa9f:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
