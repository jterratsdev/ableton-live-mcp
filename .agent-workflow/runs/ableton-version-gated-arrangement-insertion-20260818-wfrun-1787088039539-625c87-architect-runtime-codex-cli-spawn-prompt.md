...
- Arrangement MIDI note writing uses add_new_notes when callable, uses set_notes only as an explicit compatibility fallback, reports the method used, and its Live 12 fixture asserts no deprecated set_notes call occurs.
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-version-gated-arrangement-insertion-20260818-wfrun-1787088039539-625c87-architect-architect-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-version-gated-arrangement-insertion-20260818-wfrun-1787088039539-625c87-architect-architect-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-version-gated-arrangement-insertion-20260818:wfrun-1787088039539-625c87:architect:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-version-gated-arrangement-insertion-20260818-wfrun-1787088039539-625c87-architect-architect-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-version-gated-arrangement-insertion-20260818:wfrun-1787088039539-625c87:architect:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
