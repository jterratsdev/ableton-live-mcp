...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-session-scene-tempo-signature-20260820:wfrun-1787185194034-63cc7d:po:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-session-scene-tempo-signature-20260820:wfrun-1787185194034-63cc7d:po:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-session-scene-tempo-signature-20260820-wfrun-1787185194034-63cc7d-po-product_owner-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-session-scene-tempo-signature-20260820:wfrun-1787185194034-63cc7d:po:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
- Prompt artifact: .agent-workflow/runs/ableton-session-scene-tempo-signature-20260820-wfrun-1787185194034-63cc7d-po-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-session-scene-tempo-signature-20260820-wfrun-1787185194034-63cc7d-po-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-session-scene-tempo-signature-20260820-wfrun-1787185194034-63cc7d-po-product_owner-runtime-handoff.md
...
- collection-standards: eligible task roles: developer, qa; task text matches triggers: fixture, fixtures
...
- source-of-truth: eligible task roles: architect, developer, qa; task text matches triggers: documentation, docs
...
## Quality Warnings
- context token estimate 6610 exceeds budget 3000
