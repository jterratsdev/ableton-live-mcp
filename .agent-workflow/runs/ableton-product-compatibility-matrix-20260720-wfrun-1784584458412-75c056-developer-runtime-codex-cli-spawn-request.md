# Runtime Spawn Request: ableton-product-compatibility-matrix-20260720
...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-product-compatibility-matrix-20260720:wfrun-1784584458412-75c056:developer:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-product-compatibility-matrix-20260720:wfrun-1784584458412-75c056:developer:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-product-compatibility-matrix-20260720-wfrun-1784584458412-75c056-developer-developer-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-product-compatibility-matrix-20260720:wfrun-1784584458412-75c056:developer:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
## Assignment
- Ownership paths: docs/ableton-compatibility.md, test/compatibility-matrix.mjs
...
- Prompt artifact: .agent-workflow/runs/ableton-product-compatibility-matrix-20260720-wfrun-1784584458412-75c056-developer-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-product-compatibility-matrix-20260720-wfrun-1784584458412-75c056-developer-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-product-compatibility-matrix-20260720-wfrun-1784584458412-75c056-developer-developer-runtime-handoff.md
...
- collection-standards: eligible task roles: developer; task text matches triggers: matrix
...
## Quality Warnings
- context token estimate 4461 exceeds budget 3000
