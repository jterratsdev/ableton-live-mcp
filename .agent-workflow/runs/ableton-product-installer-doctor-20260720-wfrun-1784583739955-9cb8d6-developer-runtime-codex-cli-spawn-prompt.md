# Runtime Child Prompt: ableton-product-installer-doctor-20260720
...
## Goal
Make installation and stale bridge troubleshooting product-grade.

## Acceptance Criteria
- Provide a doctor command that reports Ableton app path, installed Remote Script path, file freshness, Live PID, bridge status, and stale-runtime diagnosis.
- Improve installer guidance so users can verify installation without manual curl commands.
- Add tests or deterministic checks for diagnostic output where feasible.
...
- original: 445 lines / 22785 bytes
- final: 262 lines / 13664 bytes
...
- sourcePath: src/doctor.js
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: src/doctor.js.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- sourcePath: docs/ableton-python-remote-script.md
- strategy: section-extraction
- originalSize: 203 lines / 9764 bytes
- finalSize: 18 lines / 504 bytes
- omittedContentWarning: Reduced from 203 lines using section-extraction; full source remains at docs/ableton-python-remote-script.md.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-product-installer-doctor-20260720-wfrun-1784583739955-9cb8d6-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-product-installer-doctor-20260720-wfrun-1784583739955-9cb8d6-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-product-installer-doctor-20260720:wfrun-1784583739955-9cb8d6:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-product-installer-doctor-20260720-wfrun-1784583739955-9cb8d6-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-product-installer-doctor-20260720:wfrun-1784583739955-9cb8d6:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
