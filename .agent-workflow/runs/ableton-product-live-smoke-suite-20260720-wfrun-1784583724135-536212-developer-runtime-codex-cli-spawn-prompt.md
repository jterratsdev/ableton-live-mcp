# Runtime Child Prompt: ableton-product-live-smoke-suite-20260720

- Runtime: codex-cli
- Task id: ableton-product-live-smoke-suite-20260720
- Phase: developer
- Role: developer
- Session id: ableton-product-live-smoke-suite-20260720:wfrun-1784583724135-536212:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Make real Ableton validation repeatable and risk-tiered instead of manual curl probes.

## Acceptance Criteria
- Add a read-only live smoke suite covering status, project, meters, browser, arrangement, devices, returns, and routing.
- Define separate safe-write and destructive suites gated by explicit environment variables.
- Document how to run live smokes without accidentally mutating a user set.
...
- original: 242 lines / 13021 bytes
- final: 242 lines / 13019 bytes
...
- sourcePath: test/live-smoke-suite.mjs
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: test/live-smoke-suite.mjs.
...
- sourcePath: test/live-smoke-readonly.mjs
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: test/live-smoke-readonly.mjs.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- sourcePath: test/live-smoke-safe-write.mjs
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: test/live-smoke-safe-write.mjs.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- sourcePath: docs/live-smoke-suite.md
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: docs/live-smoke-suite.md.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- strategy: passthrough
- originalSize: 22 lines / 711 bytes
- finalSize: 22 lines / 710 bytes
- omittedContentWarning: none
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
```
{
  ...
  "scripts": {
    ...
    "install:ableton-remote-script": "bash scripts/install-ableton-remote-script.sh",
    "start": "node src/server.js",
    "smoke": "node test/smoke.mjs",
    "smoke:bridge": "node test/bridge-smoke-report.mjs",
    "test": "node test/smoke.mjs && node test/regression.mjs && node test/bridge.mjs && node test/remote-script-static.mjs"
  },
  "engines": {
    "node": ">=18"
  },
...
- Load budget: normal
- Rationale: task text matches triggers: browser, ui
- Instructions:
...
- Load budget: normal
- Rationale: task text matches triggers: routing
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-product-live-smoke-suite-20260720-wfrun-1784583724135-536212-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-product-live-smoke-suite-20260720-wfrun-1784583724135-536212-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-product-live-smoke-suite-20260720:wfrun-1784583724135-536212:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-product-live-smoke-suite-20260720-wfrun-1784583724135-536212-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-product-live-smoke-suite-20260720:wfrun-1784583724135-536212:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
