# Runtime Spawn Request: ableton-adapter-modularization-20260720
...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-adapter-modularization-20260720:wfrun-1784524757028-e1e152:developer:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-adapter-modularization-20260720:wfrun-1784524757028-e1e152:developer:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-adapter-modularization-20260720-wfrun-1784524757028-e1e152-developer-developer-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-adapter-modularization-20260720:wfrun-1784524757028-e1e152:developer:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
## Assignment
- Ownership paths: bridge, ableton_remote_scripts, src, test, docs
...
- Prompt artifact: .agent-workflow/runs/ableton-adapter-modularization-20260720-wfrun-1784524757028-e1e152-developer-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-adapter-modularization-20260720-wfrun-1784524757028-e1e152-developer-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-adapter-modularization-20260720-wfrun-1784524757028-e1e152-developer-developer-runtime-handoff.md
...
## Selected Skills
- prompt-registry: eligible task roles: developer; task text matches triggers: code, docs; task touches files, so prompt registry can preserve artifact intent
...
## Quality Warnings
- context token estimate 3581 exceeds budget 3000
