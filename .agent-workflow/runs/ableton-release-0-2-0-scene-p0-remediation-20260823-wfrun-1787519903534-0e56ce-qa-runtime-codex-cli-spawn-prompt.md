...
- original: 1319 lines / 70004 bytes
- final: 360 lines / 25944 bytes
...
[... omitted 325 lines; full source path available ...]
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-qa-qa-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-qa-qa-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-release-0-2-0-scene-p0-remediation-20260823:wfrun-1787519903534-0e56ce:qa:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-release-0-2-0-scene-p0-remediation-20260823-wfrun-1787519903534-0e56ce-qa-qa-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-release-0-2-0-scene-p0-remediation-20260823:wfrun-1787519903534-0e56ce:qa:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
