# Runtime Child Prompt: ableton-product-risk-policy-20260720

- Runtime: codex-cli
- Task id: ableton-product-risk-policy-20260720
- Phase: developer
- Role: developer
- Session id: ableton-product-risk-policy-20260720:wfrun-1784584017770-98a627:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Create the safety layer needed before exposing destructive production actions broadly.

## Acceptance Criteria
- Classify MCP tools and HTTP endpoints into read, safe-write, destructive, export, and unsupported risk tiers.
- Provide a reusable policy module that callers can use before mutating Ableton state.
- Add tests for classification and default blocking recommendations.
...
- sourcePath: src/risk-policy.js
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: src/risk-policy.js.
...
- sourcePath: test/risk-policy.mjs
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: test/risk-policy.mjs.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- sourcePath: docs/risk-policy.md
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: docs/risk-policy.md.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-product-risk-policy-20260720-wfrun-1784584017770-98a627-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-product-risk-policy-20260720-wfrun-1784584017770-98a627-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-product-risk-policy-20260720:wfrun-1784584017770-98a627:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-product-risk-policy-20260720-wfrun-1784584017770-98a627-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-product-risk-policy-20260720:wfrun-1784584017770-98a627:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
