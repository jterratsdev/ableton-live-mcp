...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-session-scene-tempo-signature-20260820-wfrun-1787519127542-f884c8-architect-architect-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-session-scene-tempo-signature-20260820-wfrun-1787519127542-f884c8-architect-architect-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-session-scene-tempo-signature-20260820:wfrun-1787519127542-f884c8:architect:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-session-scene-tempo-signature-20260820-wfrun-1787519127542-f884c8-architect-architect-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-session-scene-tempo-signature-20260820:wfrun-1787519127542-f884c8:architect:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
