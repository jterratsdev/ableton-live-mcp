# Runtime Child Prompt: ableton-live-meter-cache-20260722

- Runtime: codex-cli
- Task id: ableton-live-meter-cache-20260722
- Phase: developer
- Role: developer
- Session id: ableton-live-meter-cache-20260722:wfrun-1784740603830-e249aa:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Fix Remote Script metering so /meters can report real Live audio signal when direct meter property reads stay at zero, using listener-backed cached values and explicit diagnostics.
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-live-meter-cache-20260722-wfrun-1784740603830-e249aa-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-live-meter-cache-20260722-wfrun-1784740603830-e249aa-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-live-meter-cache-20260722:wfrun-1784740603830-e249aa:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-live-meter-cache-20260722-wfrun-1784740603830-e249aa-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-live-meter-cache-20260722:wfrun-1784740603830-e249aa:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
