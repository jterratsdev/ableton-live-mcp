# Runtime Spawn Request: ableton-bridge-minimal-20260716
...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-bridge-minimal-20260716:wfrun-1784240094860-3dbb0c:developer:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-bridge-minimal-20260716:wfrun-1784240094860-3dbb0c:developer:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-bridge-minimal-20260716-wfrun-1784240094860-3dbb0c-developer-developer-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-bridge-minimal-20260716:wfrun-1784240094860-3dbb0c:developer:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
## Assignment
- Ownership paths: bridge, src, docs, test, README.md, package.json
...
- Prompt artifact: .agent-workflow/runs/ableton-bridge-minimal-20260716-wfrun-1784240094860-3dbb0c-developer-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-bridge-minimal-20260716-wfrun-1784240094860-3dbb0c-developer-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-bridge-minimal-20260716-wfrun-1784240094860-3dbb0c-developer-developer-runtime-handoff.md
...
## Selected Skills
- oclif-plugin-development: eligible task roles: developer; task text matches triggers: plugin, plugins
- source-of-truth: eligible task roles: developer; task text matches triggers: docs, verify
...
- qa-evidence-pack: eligible task roles: developer; task text matches triggers: integration
- static-analysis: eligible task roles: developer; task text matches triggers: test
- doc-sync: task text matches triggers: docs, readme
...
## Quality Warnings
- context token estimate 4638 exceeds budget 3000
