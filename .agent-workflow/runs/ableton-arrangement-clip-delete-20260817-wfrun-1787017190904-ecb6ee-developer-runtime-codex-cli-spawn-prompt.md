...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-arrangement-clip-delete-20260817-wfrun-1787017190904-ecb6ee-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-arrangement-clip-delete-20260817-wfrun-1787017190904-ecb6ee-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-arrangement-clip-delete-20260817:wfrun-1787017190904-ecb6ee:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-arrangement-clip-delete-20260817-wfrun-1787017190904-ecb6ee-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-arrangement-clip-delete-20260817:wfrun-1787017190904-ecb6ee:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
