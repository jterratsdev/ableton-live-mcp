...
- Run: wfrun-1785867783071-9934d0
...
- Goal: Create a polished standalone product site for the open-source Ableton Live MCP connector that matches jterrats.dev while remaining isolated from the npm package runtime.

## Acceptance Criteria
- Opening site/index.html at desktop and mobile widths shows the Ableton Live MCP product name, open-source status, installation commands, architecture, verified capabilities, safety model, limitations, and GitHub call to action without overlap or horizontal overflow.
...
## Approval
Approve: orchestra workflow run --task ableton-connector-product-site-20260804 --resume wfrun-1785867783071-9934d0
