# Runtime Child Prompt: ableton-arrangement-clip-delete-20260817

- Runtime: codex-cli
- Task id: ableton-arrangement-clip-delete-20260817
- Phase: developer
- Role: developer
- Session id: ableton-arrangement-clip-delete-20260817:wfrun-1787013984447-aaf633:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Provide a verified MCP workflow that previews and deletes exact Arrangement clips without affecting Session clips or non-selected Arrangement material.

## Acceptance Criteria
- A listed read-only MCP planning tool returns exact Arrangement clip candidates with stable track and clip identity, start beat, and length, while tests confirm project state is unchanged.
- A separately listed destructive MCP tool accepts only exact pre-resolved Arrangement clip identities and tests confirm it deletes every selected clip while preserving all unselected Arrangement and Session clips.
- Tests confirm stale, missing, duplicated, ambiguous, or partially unsupported selections fail closed without deleting a different clip, and the response reports per-clip verification results.
- Running focused Node and Python fake-Live tests plus npm test produces exit code 0 without invoking a mutating endpoint on the user's active Ableton Set.
...
- Load budget: small
- Rationale: eligible task roles: developer, qa; task text matches triggers: fixture, fixtures, selector, selectors
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: developer, qa; task text matches triggers: code, ui, docs; task touches files, so prompt registry can preserve artifact intent
- Instructions:
...
- Load budget: normal
- Rationale: eligible task roles: qa; task text matches triggers: pr, review, diff
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: developer, qa; task text matches triggers: workflow
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-arrangement-clip-delete-20260817-wfrun-1787013984447-aaf633-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-arrangement-clip-delete-20260817-wfrun-1787013984447-aaf633-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-arrangement-clip-delete-20260817:wfrun-1787013984447-aaf633:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-arrangement-clip-delete-20260817-wfrun-1787013984447-aaf633-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-arrangement-clip-delete-20260817:wfrun-1787013984447-aaf633:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
