# Runtime Child Prompt: ableton-product-docs-workflows-20260720
...
## Goal
Make the MCP usable as a product without requiring internal knowledge of the repo.

## Acceptance Criteria
- Document end-to-end workflows for setup, MIDI import, instrument assignment, mixing, mastering, validation, and export.
- Document safe operating rules for open user sets and destructive commands.
- Align README product language with the current endpoint set.
...
- original: 361 lines / 17229 bytes
- final: 289 lines / 14916 bytes
...
- sourcePath: docs/product-workflows.md
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: docs/product-workflows.md.
...
- originalSize: 141 lines / 4919 bytes
- finalSize: 69 lines / 2607 bytes
- omittedContentWarning: Reduced from 141 lines using section-extraction; full source remains at README.md.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
1. `ableton_get_project` and `ableton_get_arrangement` to inspect tracks, devices, clips, locators, timeline clips, and mixer state.
...
6. `ableton_select_vst_for_midi` or `ableton_load_device` to assign sounds.
7. `ableton_duplicate_track`, `ableton_consolidate_clip`, `ableton_insert_arrangement_clip`, `ableton_add_locator`, `ableton_modify_track`, `ableton_set_device_parameter`, and `ableton_set_automation` for arrangement and mix moves.
...
when configured, and implements `/status`, `/project`, `/tempo`,
`/transport/start`, `/transport/stop`, and `/plugins`.
...
- Load budget: small
- Rationale: eligible task roles: developer; task text matches triggers: documentation, docs
- Instructions:
...
- Load budget: normal
- Rationale: task text matches triggers: documentation, docs, readme
- Instructions:
...
Create and execute a QA plan from acceptance criteria and risks.

- Roles: qa, sdet, developer
- Inputs: acceptance criteria, changed behavior, known gaps
- Outputs: qa plan, test results, defects
- Evidence: command, report
- Gates: qa-release
- Missing evidence: command, report

Steps:
- Map acceptance criteria to deterministic checks.
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-product-docs-workflows-20260720-wfrun-1784584574378-7942d4-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-product-docs-workflows-20260720-wfrun-1784584574378-7942d4-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-product-docs-workflows-20260720:wfrun-1784584574378-7942d4:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-product-docs-workflows-20260720-wfrun-1784584574378-7942d4-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-product-docs-workflows-20260720:wfrun-1784584574378-7942d4:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
