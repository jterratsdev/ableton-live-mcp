# Runtime Spawn Request: ableton-product-installer-doctor-20260720
...
- Spawn lifecycle: orchestra runtime spawn-lifecycle --session ableton-product-installer-doctor-20260720:wfrun-1784583739955-9cb8d6:developer:codex-cli --status spawned --agent-id <agent-id>
- Complete lifecycle: orchestra runtime spawn-lifecycle --session ableton-product-installer-doctor-20260720:wfrun-1784583739955-9cb8d6:developer:codex-cli --status completed --agent-id <agent-id> --artifact .agent-workflow/handoffs/ableton-product-installer-doctor-20260720-wfrun-1784583739955-9cb8d6-developer-developer-runtime-handoff.md
- Failure lifecycle: orchestra runtime spawn-lifecycle --session ableton-product-installer-doctor-20260720:wfrun-1784583739955-9cb8d6:developer:codex-cli --status failed --agent-id <agent-id> --summary "<safe failure summary>"
...
## Assignment
- Ownership paths: scripts, src/doctor.js, docs/ableton-python-remote-script.md, package.json
...
- Prompt artifact: .agent-workflow/runs/ableton-product-installer-doctor-20260720-wfrun-1784583739955-9cb8d6-developer-runtime-codex-cli-spawn-prompt.md
- Context manifest artifact: .agent-workflow/runs/ableton-product-installer-doctor-20260720-wfrun-1784583739955-9cb8d6-developer-runtime-codex-cli-context-manifest.json
- Expected result artifact: .agent-workflow/handoffs/ableton-product-installer-doctor-20260720-wfrun-1784583739955-9cb8d6-developer-developer-runtime-handoff.md
...
## Quality Warnings
- context token estimate 3951 exceeds budget 3000
