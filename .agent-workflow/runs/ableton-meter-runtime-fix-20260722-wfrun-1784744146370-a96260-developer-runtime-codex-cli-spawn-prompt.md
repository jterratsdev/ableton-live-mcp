# Runtime Child Prompt: ableton-meter-runtime-fix-20260722

- Runtime: codex-cli
- Task id: ableton-meter-runtime-fix-20260722
- Phase: developer
- Role: developer
- Session id: ableton-meter-runtime-fix-20260722:wfrun-1784744146370-a96260:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Determine the supported Live Remote Script metering path, implement reliable observable meters or an explicit unsupported contract, and validate the result against the user's running Ableton instance without modifying the set beyond playback.
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-meter-runtime-fix-20260722-wfrun-1784744146370-a96260-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-meter-runtime-fix-20260722-wfrun-1784744146370-a96260-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-meter-runtime-fix-20260722:wfrun-1784744146370-a96260:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-meter-runtime-fix-20260722-wfrun-1784744146370-a96260-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-meter-runtime-fix-20260722:wfrun-1784744146370-a96260:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
