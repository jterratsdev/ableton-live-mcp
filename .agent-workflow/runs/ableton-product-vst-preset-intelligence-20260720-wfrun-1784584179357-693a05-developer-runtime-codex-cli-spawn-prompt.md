# Runtime Child Prompt: ableton-product-vst-preset-intelligence-20260720

- Runtime: codex-cli
- Task id: ableton-product-vst-preset-intelligence-20260720
- Phase: developer
- Role: developer
- Session id: ableton-product-vst-preset-intelligence-20260720:wfrun-1784584179357-693a05:developer:codex-cli
- Direct provider API calls: forbidden

## Goal
Move from raw browser search to musically useful VST and preset selection.

## Acceptance Criteria
- Define a local catalog format for instruments, effects, tags, realism hints, and classical production intent.
- Add matching/scoring behavior for user intents like realistic violin, concert piano, classical guitar, flute, and concert hall mastering.
- Add deterministic tests for catalog matching without requiring Ableton.
...
- omittedContentWarning: Source path was unavailable during preprocessing: bridge/presets.
...
- sourcePath: docs/vst-preset-intelligence.md
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: docs/vst-preset-intelligence.md.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
- sourcePath: test/preset-intelligence.mjs
- strategy: missing
- originalSize: 0 lines / 0 bytes
- finalSize: 0 lines / 0 bytes
- omittedContentWarning: Source path was unavailable during preprocessing: test/preset-intelligence.mjs.
- reason: Delegated ownership path; cite this path instead of loading raw file content by default.
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-product-vst-preset-intelligence-20260720-wfrun-1784584179357-693a05-developer-developer-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-product-vst-preset-intelligence-20260720-wfrun-1784584179357-693a05-developer-developer-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-product-vst-preset-intelligence-20260720:wfrun-1784584179357-693a05:developer:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-product-vst-preset-intelligence-20260720-wfrun-1784584179357-693a05-developer-developer-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-product-vst-preset-intelligence-20260720:wfrun-1784584179357-693a05:developer:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
