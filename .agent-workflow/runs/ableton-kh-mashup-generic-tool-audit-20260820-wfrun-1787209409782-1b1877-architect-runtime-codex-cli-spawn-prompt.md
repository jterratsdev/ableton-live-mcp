# Runtime Child Prompt: ableton-kh-mashup-generic-tool-audit-20260820
...
## Goal
Review the automation scripts under /Users/polux/Documents/gp/kh_mash_up/tools and identify which capabilities should become safe, reusable Ableton MCP tools, which are already covered, and which must remain project-specific.

## Acceptance Criteria
- Every Python script under kh_mash_up/tools is inventoried with purpose, inputs, outputs, external dependencies, side effects, Ableton/MCP interactions, project-specific assumptions, and overlap with existing MCP tools.
- Each reusable behavior is classified as adopt now, adopt after prerequisite, compose from existing tools, keep as local workflow, or reject, with concrete SDK/API feasibility and safety rationale.
- Recommended generic candidates include a proposed MCP name, minimal parameter schema, read-only probe or preflight, risk tier, receiver-state verification, rollback strategy, and target bridge ownership without copying project-specific constants or paths.
- The audit explicitly identifies unsafe GUI automation, direct .als mutation, fixed track/plugin names, unbounded file writes, destructive operations, and behavior that the Live SDK cannot truthfully support.
- The final prioritized roadmap distinguishes quick wins from larger features and cites exact source scripts and current MCP modules; no source file is copied or changed and no Ableton bridge/Set is contacted.
...
- Load budget: small
- Rationale: eligible task roles: architect, qa; task text matches triggers: orchestra, workflow, handoff, evidence
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: architect, qa; task text matches triggers: source, docs, verify, truth
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: qa; task text matches triggers: ui, docs; task touches files, so prompt registry can preserve artifact intent
- Instructions:
...
- Load budget: normal
- Rationale: eligible task roles: architect, qa; task text matches triggers: plugin, plugins
- Instructions:
...
- Load budget: normal
- Rationale: eligible task roles: qa, architect; task text matches triggers: pr, review
- Instructions:
...
- Load budget: normal
- Rationale: eligible task roles: qa, architect; task text matches triggers: audio
- Instructions:
...
- Load budget: small
- Rationale: eligible task roles: qa; task text matches triggers: map
- Instructions:
...
- Load budget: normal
- Rationale: eligible task roles: architect; task text matches triggers: docs
- Instructions:
...
- Load budget: normal
- Rationale: eligible task roles: qa; task text matches triggers: test
- Instructions:
...
## Return Contract
- Write or summarize result evidence for .agent-workflow/handoffs/ableton-kh-mashup-generic-tool-audit-20260820-wfrun-1787209409782-1b1877-architect-architect-runtime-handoff.md.
...
- After writing .agent-workflow/handoffs/ableton-kh-mashup-generic-tool-audit-20260820-wfrun-1787209409782-1b1877-architect-architect-runtime-handoff.md, run: orchestra runtime spawn-lifecycle --session ableton-kh-mashup-generic-tool-audit-20260820:wfrun-1787209409782-1b1877:architect:codex-cli --status completed --agent-id codex-cli:child --artifact .agent-workflow/handoffs/ableton-kh-mashup-generic-tool-audit-20260820-wfrun-1787209409782-1b1877-architect-architect-runtime-handoff.md
- If blocked or failed before completion, run: orchestra runtime spawn-lifecycle --session ableton-kh-mashup-generic-tool-audit-20260820:wfrun-1787209409782-1b1877:architect:codex-cli --status failed --agent-id codex-cli:child --summary "<safe failure summary>"
